...
RSpec.describe(DateRangeFormatter) do
  ...
  it "formats a date range for the same day with ending time" do
    formatter = DateRangeFormatter.new("2009-11-1", "2009-11-1", nil, "10:00")

    formatted_date_range = formatter.format

    expect(formatted_date_range).to eq("1st November 2009 until 10:00")
  end
  ...
  it "formats a date range for the same month with ending time" do
    ...
    expect(formatted_date_range).to eq("1st November 2009 - 3rd November 2009 at 10:00")
  end
  ...
  it "formats a date range for the same year with ending time" do
    ...
    expect(formatted_date_range).to eq("1st November 2009 - 1st December 2009 at 10:00")
  end
  ...
  it "formats a date range for different year with ending time" do
    ...
    expect(formatted_date_range).to eq("1st November 2009 - 1st December 2010 at 10:00")
  end
  ...
  it "formats a date range for different day and year" do
    formatter = DateRangeFormatter.new("2009-11-1", "2010-11-3")

    formatted_date_range = formatter.format

    expect(formatted_date_range).to eq("1st November 2009 - 3rd November 2010")
  end
end
